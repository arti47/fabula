...
export const INPUT_SPARKS = {
  ...
  'villain.fear': [
    'being found out', 'a room with nobody in it', 'somebody braver arriving', 'pity',
    'the thing they did before', '{hero}, and will not say so', 'losing what they took',
    'forgiveness, which would cost more', 'the truth, plainly said', 'someone who cannot be bought',
    'growing old', 'turning out ordinary', 'a person from long ago', 'the dark, same as everyone',
    'nothing, and that is the frightening part', 'the wrong story being told about them',
  ],
  'villain.want': [
  ...
  'boost-why-villain': [
    'left behind once, and never again', 'in their head, they are protecting somebody',
    'nobody ever said no to them', 'lost the same thing {hero} has', 'somebody told them to',
    'frightened, and hiding it well', 'it worked the first time', 'to them it is perfectly fair',
    'somebody did it to them first', 'too far in to stop now', 'laughed at, years ago',
    'they think {hero} is the villain', 'plain hunger', 'keeping a promise of their own',
    'made this way by somebody else', 'no reason — and that is worse',
  ],
  'boost-too-easy': [
  ...
  'boost-faults': [
    'never listens properly', 'too proud to ask', 'lies when frightened',
    'always late', 'cannot leave anything alone', 'takes the credit',
    'trusts far too quickly', 'runs first, thinks after', 'stubborn about the wrong things',
    'laughs at the wrong moment', 'careless with other people', 'cannot say sorry',
    'needs to be liked too much', 'gives up one minute early', 'jealous, quietly',
