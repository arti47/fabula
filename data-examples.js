...
export const EXAMPLE_STORIES = [
  {
    ...
    boosts: {
      'boost-care': { answer: 'Her mother, and her grandmother most of all.', skipped: false, spawned: [], editedBeats: [] },
      'boost-help': { answer: 'The Hunter — and we wait a very long time for him. Without him she would not have made it.', skipped: false, spawned: [], editedBeats: [] },
      'boost-why-villain': { answer: 'Did the Wolf ever choose to be what he is? He is hungry, and he is good at lying, and nobody in the story asks him anything.', skipped: false, spawned: [], editedBeats: [] },
      'boost-too-easy': { answer: 'If she had recognised him at the first meeting it would be half a story. She has to be fooled twice.', skipped: false, spawned: [], editedBeats: [] },
      'boost-background': { answer: 'She loves her grandmother and she is a little unruly. And what is the Wolf’s story? Or the Hunter’s?', skipped: false, spawned: [], editedBeats: [] },
      'boost-narrator': { answer: 'Someone outside it all, telling it long afterwards. Imagine it told by Grandma instead.', skipped: false, spawned: [], editedBeats: [] },
      'boost-despair': { answer: 'The moment she is swallowed and everything goes dark. All hope gone.', skipped: false, spawned: [], editedBeats: [] },
      'boost-faults': { answer: 'She disobeys her mother, and she stops for flowers when she should be walking.', skipped: false, spawned: [], editedBeats: [] },
      'boost-learn': { answer: 'Never to trust appearances again.', skipped: false, spawned: [], editedBeats: [] },
    },
    snapshot: null,
    skipped: [],
  },

  {
    ...
    boosts: {
      'boost-help': { answer: 'Hänsel is on his own the whole way through. Give him a little sister — Gretel — so he has somebody to protect, and somebody who can save him.', skipped: false, spawned: ['hg-gretel'], editedBeats: [1, 6, 7] },
      'boost-care': { answer: 'The two of them love each other, and they love their father.', skipped: false, spawned: [], editedBeats: [] },
      'boost-why-villain': { answer: 'The old woman seems kind and is not. And why did nobody come back for them? Because the mother is a stepmother, and she talked their father into it.', skipped: false, spawned: ['hg-stepmother'], editedBeats: [2] },
      'boost-too-easy': { answer: 'Make them face it twice: the pebbles work, the breadcrumbs do not. And put a river in the way of going home — with the same duck that ate the crumbs, wanting to be forgiven.', skipped: false, spawned: [], editedBeats: [3, 4, 5, 8] },
      'boost-twist': { answer: 'Everyone expects Hänsel to get them out. It is Gretel — the younger, the frightened one — who puts the witch in her own oven.', skipped: false, spawned: [], editedBeats: [7] },
      'boost-background': { answer: 'The family is desperately poor with almost nothing to eat, and that is the whole reason the stepmother can talk their father into it.', skipped: false, spawned: [], editedBeats: [1] },
      'boost-narrator': { answer: 'Someone outside the story, telling it afterwards — though it could be told by Hänsel and Gretel themselves.', skipped: false, spawned: [], editedBeats: [] },
      'boost-despair': { answer: 'Two of them: the moment the crumbs are gone, and the moment Hänsel is in the cage being fattened while Gretel has to help.', skipped: false, spawned: [], editedBeats: [5] },
      'boost-faults': { answer: 'They are good children and completely naive. They see a house made of sweets and think they are safe.', skipped: false, spawned: [], editedBeats: [] },
      'boost-learn': { answer: 'Not to trust how things look — and that they can count on each other. He gives her courage when they are lost; she saves him when it matters most.', skipped: false, spawned: [], editedBeats: [9] },
    },
